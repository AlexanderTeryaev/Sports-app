...
function printClickAlternativeLandscape() {
    if ($('#print_print_id , .print_button_class').length > 0) {
        //$('#print_print_id , .print_button_class').hide();
        windowPrint($('#print_print_id , .print_button_class'), $('#print_print_id , .print_button_class').data("print-title"),false,true);
        //$('#print_print_id , .print_button_class').show();
    }
}
...
function windowPrint(element, title = 'Game schedules', isInstant = false, isLandscape = false) {
    ...
    wnd.document.write('<link rel="stylesheet" href="/Content/css/bootstrap.css" type="text/css" media="print" />');
    ...
    wnd.document.write('<link rel="stylesheet" href="/Content/css/style.css" type="text/css" /><style class="bracket_print"></style>');
    ...
    wnd.document.write('<style>.text-print-center, .text-print-center h3 {text-align: center;margin:18px;} .col-sm-8, .col-sm-6{width:unset;float: none;} table {margin-inline-start: auto; margin-inline-end: auto;margin: 10px;} h3, h4 {margin:18px;}</style>');
