    ...
    $.extend(ColReorder.prototype, {
        ...
        */
        ...
        "_fnMouseMove": function (e) {
            ...
            var rtl = false;
            if ($(".dataTables_wrapper").css("direction").toLowerCase() === "rtl") {
                rtl = true;
            }

            if (rtl) {
                for (var i = 1, iLen = this.s.aoTargets.length; i < iLen; i++) {
                    if (this._fnCursorPosition(e, 'pageX') < this.s.aoTargets[i - 1].x - ((this.s.aoTargets[i - 1].x - this.s.aoTargets[i].x) / 2)) {
                        this.dom.pointer.css('left', this.s.aoTargets[i - 1].x);
                        this.s.mouse.toIndex = this.s.aoTargets[iLen - i - 1].to;
                        bSet = true;
                        break;
                    }
                }
            ...
            if (!bSet) {
                this.dom.pointer.css('left', rtl ? this.s.aoTargets[0].x : this.s.aoTargets[this.s.aoTargets.length - 1].x);
                this.s.mouse.toIndex = rtl ? 0 : this.s.aoTargets[this.s.aoTargets.length - 1].to;
            }
